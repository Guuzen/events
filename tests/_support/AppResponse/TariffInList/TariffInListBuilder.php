...
final class TariffInListBuilder
{
    private $id;
    ...
    public function build(): TariffInList
    {
        return new TariffInList($this->id, $this->productType, $this->price, $this->termStart, $this->termEnd);
    }
